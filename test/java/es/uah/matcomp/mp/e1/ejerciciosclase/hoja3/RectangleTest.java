...
class RectangleTest {
    ...
    void setLength() {
        ...
        es.uah.matcomp.mp.e1.ejerciciosclase.hoja3.Rectangle d = new es.uah.matcomp.mp.e1.ejerciciosclase.hoja3.Rectangle();
    ...
    @Test
    void getArea() {
        Rectangle d = new Rectangle(3.7,4.8);
    ...
    @Test
    void testToString() {
        Rectangle f = new Rectangle("blue", false);
        assertEquals("blue",f.getColor(),"los colores no son iguales");
        es.uah.matcomp.mp.e1.ejerciciosclase.hoja3.Rectangle d = new es.uah.matcomp.mp.e1.ejerciciosclase.hoja3.Rectangle("red", true,3.1,6.9);
